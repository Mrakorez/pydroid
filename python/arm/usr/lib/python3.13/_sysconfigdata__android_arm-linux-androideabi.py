...
build_time_vars = {
    ...
    'BLDSHARED': 'clang -shared -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CC': 'clang',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include',
    ...
    'CONFIGURE_CFLAGS': '-D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8',
    'CONFIGURE_LDFLAGS_NODIST': '-flto=thin -g',
    'CONFIGURE_LDFLAGS_NOLTO': '-flto=thin',
    'CONFIG_ARGS': "'--host=arm-linux-androideabi' '--build=x86_64-pc-linux-gnu' '--with-build-python=/home/da3m0n/dev/Python-3.13.1/cross-build/build/python' '--without-ensurepip' '--enable-shared' '--without-static-libpython' '--with-openssl=/data/local/pydroid/usr' '--with-lto' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=arm-linux-androideabi' 'PKG_CONFIG=pkg-config --define-prefix' 'PKG_CONFIG_LIBDIR=/data/local/pydroid/usr/lib/pkgconfig' 'CC=clang' 'CFLAGS=-D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include' 'LDFLAGS=-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib'",
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'clang++ -shared -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib',
    'LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'clang -shared -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.13',
    'LIBDIR': '/usr/local/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I../../../Modules/expat -mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../../../Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/data/local/pydroid/usr/include',
    'MODULE__CTYPES_DEPS': '../../../Modules/_ctypes/ctypes.h',
    'MODULE__CTYPES_LDFLAGS': '-L/data/local/pydroid/usr/lib -lffi -ldl',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/data/local/pydroid/usr/include',
    'MODULE__HASHLIB_DEPS': '../../../Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/data/local/pydroid/usr/lib   -lcrypto',
    ...
    'MODULE__LZMA_CFLAGS': '-I/data/local/pydroid/usr/include',
    'MODULE__LZMA_LDFLAGS': '-L/data/local/pydroid/usr/lib -llzma',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/data/local/pydroid/usr/include -I../../../Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/data/local/pydroid/usr/lib -lsqlite3',
    'MODULE__SQLITE3_STATE': 'yes',
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/data/local/pydroid/usr/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/data/local/pydroid/usr/lib  -lssl -lcrypto',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include',
    ...
    'PY_CORE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -flto=thin -g',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../../Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib',
    'PY_LDFLAGS_NODIST': '-flto=thin -g',
    'PY_LDFLAGS_NOLTO': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/data/local/pydroid/usr/lib -flto=thin',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -D__BIONIC_NO_PAGE_SIZE_MACRO -march=armv7-a -mthumb -I/data/local/pydroid/usr/include -flto=thin -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../../Include/internal -I../../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../../Include -fPIC',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
